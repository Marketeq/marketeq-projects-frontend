...
import { decryptWithPrivateKey } from '../crypto/e2ee'; // WebCrypto wrapper
import { saveKey } from '../crypto/indexedDb';

export function useConversationKey(convId: string, wrappedKeyB64: string, myPrivPem: string) {
