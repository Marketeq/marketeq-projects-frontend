...
export async function encryptMessage(plainText: string, recipientPublicKey: CryptoKey) {
...
export async function decryptMessage(cipherText: string, privateKey: CryptoKey) {
