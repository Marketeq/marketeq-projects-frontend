...
export default function FavoriteProjects() {
  ...
  return (
    <div className="p-3.5 md:p-10 lg:py-[100px] lg:px-[200px]">
      ...
      <Tabs className="mt-6 lg:mt-[19px]" defaultValue="projects">
        <div className="flex items-center border-b border-gray-200 pb-0.5 mb-2">
          <Button
          ...
          <TabsList className="flex border-b-0 px-0 xs:max-lg:pt-2">
          ...
          <div className="ml-auto flex items-center gap-x-3">
            ...
            <ToggleGroupRoot value={value} onValueChange={(details) => setValue(details.value)} className="bg-gray-50 rounded-md px-1 py-1">
              <ToggleGroupItem className="xs:max-lg:size-[30px]" value={GRID_LAYOUT}>
                <Grid className="size-5 lg:size-6" />
              </ToggleGroupItem>
              <ToggleGroupItem className="xs:max-lg:size-[30px]" value={LIST_LAYOUT}>
                <List className="size-5 lg:size-6" />
              </ToggleGroupItem>
            </ToggleGroupRoot>
            <Modal />
        ...
        <TabsContent value="projects">
          ...
          <Tabs className="mt-0" defaultValue="All">
            <div className="border-b h-10 lg:h-[60px] flex items-end justify-between border-gray-200">
              <div className="items-end inline-flex gap-x-3">
                <TabsList className="flex justify-start border-b-0 px-0 xs:max-lg:pt-2">
                  <TabsTrigger className="xs:max-lg:text-xs xs:max-lg:leading-5" value="All">All Projects</TabsTrigger>
                  <TabsTrigger className="xs:max-lg:text-xs xs-max-lg:leading-5" value="Recent">Recent</TabsTrigger>
                </TabsList>
              </div>
            </div>
        ...
        <TabsContent value="services">
          <div className="text-center py-20 text-gray-400">No favorite services yet.</div>
        </TabsContent>
        <TabsContent value="talent">
          <div className="text-center py-20 text-gray-400">No favorite talent yet.</div>
        </TabsContent>
        <TabsContent value="teams">
          <div className="text-center py-20 text-gray-400">No favorite teams yet.</div>
        </TabsContent>
        <TabsContent value="jobs">
          <div className="text-center py-20 text-gray-400">No favorite jobs yet.</div>
        </TabsContent>
      </Tabs>
    </div>
  )
