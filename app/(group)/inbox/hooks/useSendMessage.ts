...
import {  encryptAES, decryptWithPrivateKey } from "../../../../src/crypto/e2ee";
 ...
 */
export function useSendMessage(token: string, privateKey: CryptoKey  | null, isGroup: boolean = false) {
  /**
