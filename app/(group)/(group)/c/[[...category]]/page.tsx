...
import { getAllFavorites, addFavorite, removeFavorite, findFavoriteByItemId  } from '../../../../../src/lib/api/favorites';
import { useCategoryPageL1, useCategoryPageL2, useCategoryPageL3 } from '../../../../../src/features/category-pages/hook';
...
export default function Projects() {
    ...
    console.log('🔍 Which hook will be called?', l3 && l2 && l1 ? 'L3' : l2 && l1 ? 'L2' : l1 ? 'L1' : 'NONE');

    // ✅ Call hooks conditionally (NOT inside useMemo)
    const { data: pageData, isLoading } = l3 && l2 && l1
        ? useCategoryPageL3(l1, l2, l3, { kind: 'projects' })
        : l2 && l1
            ? useCategoryPageL2(l1, l2, { kind: 'projects' })
            : l1
                ? useCategoryPageL1(l1, { kind: 'projects' })
    ...
    const categorySlugPath = pageData?.breadcrumbs?.map(b => b.slug) || actualCategory || [];
                                                ...
                                                <FavoriteRoot
                                                    ...
                                                    onValueChange={async (pressed) => {
                                                        if (pressed) {
                                                            ...
                                                            const favorite = await findFavoriteByItemId(String(project.id));
