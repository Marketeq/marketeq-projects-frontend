  ...
  return (
    <div className="flex h-screen">
      ...
      <div className="flex-auto">
        <Header />
        <ScrollArea
          className="h-[calc(theme(size.full)-70px)]"
        ...
        >
          ...
          <div className="h-[78px] bg-white border-b border-gray-200">
            ...
            <div className="flex-auto">
              ...
              <div className="space-y-3 mt-6">
                ...
                <InputGroup>
                  ...
                  <Input type="email" placeholder="www.video.com" />
                </InputGroup>
              </div>
            </div>
            <div className="pl-[17.45px]">
            ...
            <div className="rounded-lg border border-gray-100 shadow-xs">
              <div className="mb-3 flex items-start justify-between px-3 pt-3">
                <div className="inline-flex items-center gap-x-3.5">
                  ...
                  <h3 className="text-[18px] font-semibold leading-7 text-gray-900">
                    Files uploaded <span className="font-light">Research</span>
                  </h3>
                </div>
