      ...
      <div className="py-[50px]">
        <div className="max-w-[1440px] mx-auto px-[50px]">
              ...
              <SwiperRoot>
                ...
                <div className="mt-6">
                  <TabsContent
                    ...
                    value="Projects"
                  >
                    <SwiperContent slidesPerView={4} spaceBetween={20}>
                      {Array(6)
                        .fill(0)
                        .map((_, index) => (
          ...
          <div className="mt-[50px]">
            ...
            <div className="mt-6 gap-5 grid grid-cols-4">
              <article className="py-[50px] bg-error-700 flex flex-col items-start justify-end px-6">
                <h1 className="text-[28px] font-bold leading-none text-white">
                  Cybersecurity Services
                </h1>
                <p className="mt-3 text-lg font-light leading-none text-white">
                  Explore cloud computing services tailored to meet your unique
                  business needs.
                </p>
                <Button
                  className="rounded-full bg-white text-error-700 mt-8"
                  size="lg"
                >
                  Explore more <ArrowRight className="size-[15px]" />
                </Button>
